        ...
        {currentNetworks.map((network, index) => (
          <div key={network.id}>
            <div
              ...
              className="py-4 hover:bg-indigo-50/50 group rounded-lg -mx-4 px-4 transition-colors cursor-pointer"
            >
              <div className="flex justify-between items-center">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <MapPin className="h-4 w-4 text-[#FF6B3D]" />
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5">
                      <Building2 className="h-4 w-4 text-[#FF6B3D]" />
